...
export const FEATURED: Featured[] = [
  ...
  },
  {
    ...
    intro:
      "Sterile-field macro captured through a custom housing on a long stop. The brief was a single image. We delivered a series — one of which now hangs at scale in the Institute lobby.",
    position: "40% 60%",
    textPosition: "right-bottom",
  },
  {
...
export const CATEGORIES: Category[] = [
  {
    ...
    body: "Photography for institutions, industry, and infrastructure. Faithful colour, archival masters, press-ready exports — the discipline that built the studio.",
    count: "198",
    demoKind: "image",
  ...
  },
  {
    ...
    body: "Detailed meshes and gaussian splat fields. Real-time, web-deliverable, ready for the digital twin, the conservation file, or the museum kiosk.",
    count: "31",
    demoKind: "model",
